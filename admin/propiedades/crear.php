<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if( empty($errores) ){
            ...
            $query = "INSERT INTO propiedades (titulo, precio, descripcion, imagen, habitaciones, wc, estacionamiento, creado , vendedorId) VALUES ('$titulo','$precio', '$descripcion','$nombreImagen','$habitaciones','$wc','$estacionamiento', '$creado','$vendedorId')";
            // echo $query;
